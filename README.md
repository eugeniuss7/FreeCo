...
## 📱 Usage
Once you have the app running, here is the typical flow for a user:

Create Your Profile: Sign up and select your Topic Tags (interests you are knowledgeable about or want to discuss).

Post an Offer: Tap the + button to broadcast a coffee offer.

Example: "Starbucks on 5th Ave • 2:00 PM • Topic: Discussing React Native Architecture."

Browse & Match: Look through the map or list view for offers near you. If you see a topic you like, request to join!

Match Messaging: Once the host accepts your request, a private chat opens. Use this to confirm the table number or exact location.
...
Create a Feature Branch (git checkout -b feature/NewCoolFeature).

Commit Your Changes (git commit -m 'Add some NewCoolFeature').
